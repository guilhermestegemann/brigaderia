...
/*
 * Verifica o estado do objeto cfg recebido, ou seja, se o identificado cfg
 * trata-se realmente de uma variável de objeto contedo suas respectivas 
 ...
 * dos dados encontrados em cfg.data em JSON para que posteriormente possam ser repassados pelo AJax
 * a partir de um pedido HTTP.
...
/* 
 * A função abaixo verifica se os dados apontados por cfg tratam-se de um array de dados, ou se é um objeto simples,
 * criado como {} ou new Object e por último verifica se trata-se de uma função objeto JavaScript. Retorna o tipo
...
BRIGADERIA.ajax.post = function(cfg){
	/*Inicia o Ajax e processa um pedido de Ajax, a partir de ajaxRequesDefault().
	...
	/*Chama a função verifyObjectData() que, por sua vez, verifica o estado do objeto cfg recebido, ou seja,
	 * se o identificador cfg trata-se realmente de uma variavel de objeto contendo suas respectivas propriedades com valores,
